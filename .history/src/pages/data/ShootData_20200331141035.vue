    ...
    <div class="shootData__con">
      ...
      <div class="data__table">
        <el-table :data="tableData" border style="width: 100%" max-height="330">
          ...
          <el-table-column fixed prop="cityName" label="所属区域" width="180" height="50" align="center"></el-table-column>
          <el-table-column fixed prop="areaName" label="所属区域" width="180" height="50" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    found() {
      ...
      let VM = this;
      this.$http.api
        .get(window.BASEURL.testUrl1 + `/parent-police/api/v1/taskStatistics?areaIds=${VM.areaIds}&startTime=${VM.startTime}&endTime=${endTime}&type=${VM.type}`)
        .then(function(res) {
          if (res.data.code === 0) {
      ...
      this.$http.api
        ...
        .then(function(res) {
          if (res.data.code === 0) {
            ...
            VM.areaIds = VM.deviceData.areaIds;
