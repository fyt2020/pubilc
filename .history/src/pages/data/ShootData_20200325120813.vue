    ...
    <div class="shootData__con">
      ...
      <div class="data__table">
        <el-table :data="tableData" border style="width: 100%" max-height="330">
          <el-table-column fixed  type="index" :index="indexMethod" label="序号" width="100" height="50" align="center"></el-table-column>
          <el-table-column fixed prop="orgName" label="采集单位" width="180" height="50" align="center"></el-table-column>
          <el-table-column fixed prop="sum" label="合计" width="100" height="50" align="center"></el-table-column>

          <el-table-column v-for="(item,index) in day" :key="index" :label="item" height="50" align="center">
