...
export default {
  ...
  methods: {
    ...
    showTimePanel1() {
      ...
      let startStr = new Date( this.dateVal[0] ).getHours() + new Date( this.dateVal[0] ).getMinutes() + new Date( this.dateVal[0] ).getSeconds();
      let endStr = new Date( this.dateVal[1] ).getHours() + new Date( this.dateVal[1] ).getMinutes() + new Date( this.dateVal[1] ).getSeconds();

    
    if( startStr === endStr){
  
    this.dateVal = [new Date(new Date(this.dateVal[0]).getTime()),new Date(new Date(this.dateVal[1]).getTime() +  24 * 60 * 60 * 1000 -1)]; 
