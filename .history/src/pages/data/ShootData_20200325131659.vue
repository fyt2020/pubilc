    ...
    <div class="shootData__con">
      ...
      <div class="data__table">
        <el-table :data="tableData" border style="width: 100%" max-height="330">
          ...
          <el-table-column fixed prop="sum" label="合计" width="100" height="50" align="center" fit>
            <template slot="header">
              <span>合计</span>
              <i :class="{'el-icon-circle-plus':sumKey,'el-icon-remove':!sumKey}" style="cursor:pointer" @click="sum()" v-if="sumKey"></i>
              <!-- <i class="el-icon-remove" style="cursor:pointer" @click="sum()" v-else></i> -->
            </template>
