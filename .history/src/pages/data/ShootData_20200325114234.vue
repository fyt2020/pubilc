    ...
    <div class="shootData__con">
      ...
      <div class="data__table">
        ...
        <el-table :data="tableData" border style="width: 100%" height="200">
          <el-table-column fixed prop="orgName" label="采集单位" width="180"></el-table-column>
          <el-table-column fixed prop="sum" label="合计" width="100"></el-table-column>
...
export default {
  data() {
    return {
      day:["0312","0313","0314","0315","0316","0317","0312","0313","0314","0315","0316","0317"],
