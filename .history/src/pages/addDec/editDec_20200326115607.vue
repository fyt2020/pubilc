  ...
  <div class="addDec-wrapper">
    <div class="addDec-header">
      ...
      <div class="addDec-content">
        ...
        <div class="shoot-inp">
          <div class="inp-con">
            <RadioGroup v-model="disabledGroup">
              <Radio label="默认" v-if="disabledGroup == '默认'"></Radio>
              <Radio label="服务器获取" v-if="disabledGroup == '服务器获取'"></Radio>
              <Radio label="手动添加" v-if="disabledGroup == '手动添加'"></Radio>
            </RadioGroup>
          </div>
        </div>

        <div class="shoot-inp" v-if="disabledGroup == '服务器获取' || disabledGroup == '默认'">
          <div class="one">
            <div class="inp-con">
              <label for="one">
        ...
        <div class="dec-list" v-if="disabledGroup == '服务器获取'">
          <el-table :data="userdata" stripe style="width: 100%" highlight-current-row>
            ...
            <!-- <el-table-column fixed="right" label="操作" width="350" height="40">
...
export default {
  ...
  methods: {
    ...
    update() { 
      ...
      this.isSend = true;
      this.$http.api
        .put(window.BASEURL.testUrl1 + `parent-police/api/v1/devices/${this.id}`, params)
        .then(function(res) {
