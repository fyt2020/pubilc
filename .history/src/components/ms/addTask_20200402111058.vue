...
export default {
  ...
  methods: {
    ...
    dataChange(e){
      ...
      console.log(e);
      this.dateVal1 =  [new Date( new Date(new Date(this.dateVal1[0]).getTime()) ), new Date( new Date(new Date(this.dateVal1[1]).getTime()  + 24 * 60 * 60 * 1000 - 1 ) )]

      
      // if(this.dateVal1.length > 0){

      //   console.log( new Date(new Date(this.dateVal1[1]).getTime()  + 24 * 60 * 60 * 1000 - 1 ) );
         

      //   this.dateVal1[1] = new Date( new Date(new Date(this.dateVal1[1]).getTime()  + 24 * 60 * 60 * 1000 - 1 ) );
